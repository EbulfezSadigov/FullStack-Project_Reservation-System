...
namespace My_Project.Migrations
{
    ...
    [Migration("20220827124403_detailroom")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingModelRoom", b =>
                {
            ...
            modelBuilder.Entity("My_Project.Models.Amentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("My_Project.Models.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("My_Project.Models.BookingModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("My_Project.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("My_Project.Models.Room", b =>
                {
                    ...
                    b.Property<string>("DetailText1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DetailText2")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("My_Project.Models.RoomAmentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingModelRoom", b =>
                {
                    b.HasOne("My_Project.Models.BookingModel", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("My_Project.Models.Room", null)
                        .WithMany()
            ...
            modelBuilder.Entity("My_Project.Models.RoomAmentity", b =>
                {
                    b.HasOne("My_Project.Models.Amentity", "Amentity")
                        .WithMany("RoomAmentities")
                        .HasForeignKey("AmentityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("My_Project.Models.Room", "Room")
                        .WithMany("RoomAmentities")
